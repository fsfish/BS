  ...
  <nav class="pub_select">
        ...
        <el-row>
          <el-col>
            <el-form-item label="院区名称:">
              <el-select v-model="form.name" multiple placeholder="请选择医院">
          ...
          <el-col>
            <el-form-item label="医生姓名:">
              <el-select v-model="form.name"  multiple placeholder="请选择医生">
                <el-option label="区域一" value="shanghai"></el-option>
                <el-option label="区域二" value="beijing"></el-option>
              </el-select>
            </el-form-item>
           ...
           <el-col>
            <el-form-item label="服务类型:">
              <el-select v-model="form.name"  multiple placeholder="请选择服务类型">
                <el-option label="区域一" value="shanghai"></el-option>
                <el-option label="区域二" value="beijing"></el-option>
              </el-select>
            </el-form-item>
   ...
   <section class="pub_hr">
      ...
      <div>
        ...
        <el-button class="mlem" type="primary">刷新</el-button>
        <span class="mlem">
          服务记录共<font class='pub_count'>0</font>条
        </span>
      </div>
    </section>
      <section class='main'>
