  ...
  <section class="discountIsSet">
    ...
    <section class="pub_hr">
      ...
      <div>
        ...
        <span class="mlem">
          医院折扣设置记录共<font class='pub_count'>0</font>条
        </span>
      </div>
    </section>
    <section class='main'>
    ...
    <section class="create">
       <el-dialog @close="resetForm('navform')" :close-on-click-modal="false" :title="other.title" size="tiny" v-model="alert.new_info">
                ...
                <el-option label="区域二" value="beijing"></el-option>
                    ...
                    <el-form-item label="折扣率:" prop="conAgentName" >
                        <el-input placeholder="请输入折扣率(0.00~1.00)" v-model="navform.conAgentName">
                        </el-input>
                    </el-form-item>
                </el-form>
