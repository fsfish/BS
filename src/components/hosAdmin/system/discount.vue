hosDiscount<template>
  <section class="discount">
    <nav class="pub_select">
      <el-form ref="form" :model="form" label-width="86px">
        <el-row>
        <el-col>
            <el-form-item label="折扣院区:">
              <el-select v-model="form.name" placeholder="请选择折扣院区">
    ...
    <section class="create">
      <el-dialog @close="resetForm('navform')" :close-on-click-modal="false" :title="other.title" size="tiny" v-model="alert.new_info">
        ...
        <el-form-item label="折扣院区:">
              <el-select v-model="navform.name" placeholder="请选择折扣院区">
                <el-option label="区域一" value="shanghai"></el-option>
                <el-option label="区域二" value="beijing"></el-option>
              </el-select>
            </el-form-item>
          <el-form-item label="检查项目:">
           ...
           <el-input placeholder="请输入优惠率(0.00~1.00)" v-model="navform.conAgentName"></el-input>
          </el-form-item>
        </el-form>
